...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "libOCCT-macos",
                      url: "https://github.com/flipper0l/OCCT/releases/download/7.8.1/macos-occt-V7_8_1.xcframework.zip",
                      checksum: "32767cd383cc1f05c03fabb45648b6d8d63f71a099ba3fd289f9ee040699b9ea"),
        .binaryTarget(name: "libOCCT-ios",
                      url: "https://github.com/flipper0l/OCCT/releases/download/7.8.1/ios-occt-V7_8_1.xcframework.zip",
